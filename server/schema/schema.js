    ...
    fields: {
        ...
        RemoveUser: {
            ...
            resolve(parent, args){
                ...
                if (!removedUser){
                    throw new("Error removing an User")
                }
                return removedUser;
            }
        },
        ...
        RemovePost: {
            ...
            resolve(parent, args){
                let postRemoved = Post.findByIdAndRemove(args.id).exec();
                if(!postRemoved){
                    throw new("Error removing a Post")
                }
                return postRemoved;
            }
        },
        ...
        RemoveHobby: {
            ...
            resolve(parent, args){
                let hobbyRemoved = Hobby.findByIdAndRemove(args.id).exec();
                if(!hobbyRemoved){
                    throw new ("Error removing a Hobby")
                }
                return hobbyRemoved;
            }
        }
